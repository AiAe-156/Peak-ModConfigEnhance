...
internal static class Loc
{
    ...
    internal static readonly Term[] ConfigTerms =
    {
        ...
        new(Plugin.DescTameXUnity, Plugin.DescTameXUnity,
            "装有 XUnity 时，启动即清空 AutoTranslatorConfig.ini 的 Endpoint / FallbackEndpoint，使其只做词典翻译——出厂默认的 GoogleTranslateV2 会机翻全部界面文本。确实要用机翻请关掉本项。",
            "裝有 XUnity 時，啟動即清空 AutoTranslatorConfig.ini 的 Endpoint / FallbackEndpoint，使其只做詞典翻譯——出廠預設的 GoogleTranslateV2 會機翻全部介面文字。確實要用機翻請關掉本項。"),
    };
