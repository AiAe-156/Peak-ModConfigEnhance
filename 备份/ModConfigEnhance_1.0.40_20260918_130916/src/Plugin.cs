...
public class Plugin : BaseUnityPlugin
{
    ...
    internal const string DescTameXUnity = "While XUnity is installed, empty Endpoint / FallbackEndpoint in AutoTranslatorConfig.ini at startup so it stays dictionary-only — the factory default GoogleTranslateV2 machine-translates every UI text. Turn off only if you want live machine translation.";
